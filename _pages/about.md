...
I am currently a Ph.D. student at [Academy of Interdisciplinary Studies](https://ais.hkust.edu.hk/), [Hong Kong University of Science and Technology](https://hkust.edu.hk/). My general research interests lie in spatio-temporal data mining and applied machine learning, with a focus on developing accurate, scalable, and generalizable algorithms to tackle complex real-world challenges, such as traffic congestion, energy consumption, and environmental sustainability. The long-term goal of my research is to building more intelligent, efficient, and sustainable cities with AI-powered technologies.
...
* Fundamental algorithms: Advancing the foundations of machine learning with innovations in data-centric AI, efficient deep learning, and physics-informed learning.
* Urban intelligence: Developing urban foundation models and generative city agents to understand and optimize the complex urban systems.
* AI for science: Leveraging AI to tackle grand scientific challenges, including climate modeling and prediction.
